    ...
    <div class="menu-movil">
        <ul>
            <li><a href="pages/productos.html"><img src="../static/img/encabezado-logueado/home.png" alt="home">
                    Inicio</a></li>
            <li><a href="pages/productos.html"><img src="../static/img/encabezado-logueado/grocery-store.png"
                        alt="carrito"> Ver carrito</a></li>
            <li><a href="pages/productos.html"><img src="../static/img/encabezado-logueado/bolsa-de-la-compra.png"
